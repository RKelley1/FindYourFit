...
$myquery = $connection->query("select * from userinfo where email = '$email';");  
$urow = mysqli_fetch_array($myquery);
...
?>
 ...
 <head>
   ...
   <style>
   .jumbotron {
       background-image: url("https://static.pexels.com/photos/26546/pexels-photo-26546.jpg");
...
.navbar-fixed-top.scrolled {
 ...
 <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <div class="container">
    ...
    <li><a href="/F_my.php" data-toggle="modal" data-target="#myModal1"><span class="glyphicon glyphicon-sign-up"></span> MY PROFILE</a></li>
    <li><a href="/F_index.php"> LOGOUT</a></li>
...
<div id="myModal1" class="modal fade" role="dialog">
 ...
 <div class="input-group">
     ...
     <div class="input-group">
       ...
       <input type="input" name="input_size"  class="form-control"  value="<?php echo $urow[3]; ?>" size="25" placeholder="Enter size: (S,M,L,XL)" required>

       </div>
     </div>
     <div class="input-group">
       <input type="input" name="input_fit"  class="form-control"  value="<?php echo $urow[4]; ?>" size="25" placeholder="Enter fit: (slim, trad) " required>
  ...
  <div class="col-md-4">
    <div class="thumbnail">
      <a href="<?php echo $user_link?>">
        ...
        <div class="caption">
            <h3> <?php echo "Brand: ",  $user_brand . "<br>"?> </h3>
            <h4> <?php echo "Size: ",  $user_size . "<br>"?> </h4>        
        </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="thumbnail">
      <a href="<?php echo $shirt1link?>">
        ...
        <div class="caption">
            <p>Closest fitting shirt...</p>
            <p> <?php echo "Brand: ",  $shirt1brand . "<br>"?> </h3>
            <p> <?php echo "Size: ",  $shirt1size . "<br>"?> </h4>
  ...
  <div class="col-md-4">
    <div class="thumbnail">
      <a href="<?php echo $shirt2link?>">
        ...
        <div class="caption">
            <p>Second closest fitting...</p>
            <p> <?php echo "Brand: ",  $shirt2brand . "<br>"?> </p>
            <p> <?php echo "Size: ",  $shirt2size . "<br>"?> </p>
            <p> <?php echo "Chest Size (inches): ",  $shirt2chest . "<br>"?> </p>
        </div>
